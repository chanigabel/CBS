"""Gender field processor for gender normalization.
...
class GenderFieldProcessor(FieldProcessor):
    """Process gender field with line break normalization.

    This processor handles gender normalization using GenderEngine. It searches
    for the specific gender header format "מין\\n1=זכר\\n2+נקבה" with line break
    normalization to handle various line break variants.

    Attributes:
        reader: ExcelReader instance for reading data
        writer: ExcelWriter instance for writing data
        gender_engine: GenderEngine instance for gender normalization
    ...
    def process_data(self, worksheet: Worksheet) -> None:
        ...
        Reads original gender values, applies normalization using GenderEngine
