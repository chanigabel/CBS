"""GenderEngine — gender field normalization rules.
...
Implemented rules:
    ...
    4. None / empty input
       ...
       Note: the normalization pipeline short-circuits before calling this
...
Known limitations:
    ...
    - There is no status message returned by this engine; status text is
      added by the normalization pipeline layer above.
"""
...
class GenderEngine:
    """
    Pure business logic for gender normalization.
