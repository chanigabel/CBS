"""Command-line interface for the Excel normalization pipeline.

Accepts an Excel workbook path, runs the full JSON-based normalization
...
def setup_logging(file_path: str) -> None:
    ...
    log_file = log_dir / f"normalization_{timestamp}.log"
...
def main() -> int:
    ...
    try:
        ...
        logger.info("=" * 80)
        logger.info("Excel Data Normalization - Starting")
        logger.info("=" * 80)
        ...
        logger.info("Starting workbook normalization...")
        ...
        logger.info("=" * 80)
        logger.info("Excel Data Normalization - Completed Successfully")
        logger.info("=" * 80)
