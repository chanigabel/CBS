...
5. [Name Normalization](#5-name-normalization)
...
8. [Gender Normalization](#8-gender-normalization)
...
12. [Session: Editing, Deleting, and Re-normalizing](#12-session-editing-deleting-and-re-normalizing)
