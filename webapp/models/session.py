...
class SessionRecord:
    ...
    Attributes:
        ...
        edits: Manual cell edits recorded as {(sheet_name, row_uid, field): new_value}
        working_dataset_dirty: True when the Working Dataset changed after the
                    latest successful standardization run.
    ...
    working_dataset_dirty: bool = False
    mosad_id: str = ""
    mosad_name: str = ""
