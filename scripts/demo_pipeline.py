"""Demo script showing the complete JSON-based Excel normalization pipeline.

This script demonstrates the end-to-end flow:
1. Excel (read-only) → Raw JSON extraction
2. Raw JSON → Normalization → Normalized JSON
...
def main():
    ...
    print("=" * 60)
    print("JSON-Based Excel Normalization Pipeline Demo")
    print("=" * 60)
    print()
    ...
    print("Step 2: Raw JSON data (before normalization):")
    ...
    print("Step 5: Normalized JSON data (after normalization):")
